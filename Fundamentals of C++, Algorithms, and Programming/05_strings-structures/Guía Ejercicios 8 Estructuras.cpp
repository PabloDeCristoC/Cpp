...
//1. Implemente función LlenaCurso(v), que carga el vector v con los datos de los alumnos.
void LlenaCurso (vector v)
{
    ...
    {
        cout <<"Nombre: ";cin.getline(r.nombre, largo);
        cout <<"Apellido: ";cin.getline(r.apellido, largo);
        r.nota1=creanota();
        r.nota2=creanota();
        r.nota3=creanota();
        //cin.ignore();
...
//2. Implemente función imprimeCurso(v), que muestra en pantalla los n registros del vector v.
